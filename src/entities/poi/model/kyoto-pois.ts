...
const kyotoPoisWithoutStatus: Omit<Poi, "status" | "descriptionByLanguage">[] = [
  {
    ...
    bestTimeByLanguage: { en: ["Sunrise", "Blue hour"], ru: ["Sunrise", "Blue hour"], ja: ["Sunrise", "Blue hour"] },
    difficulty: "active",
    durationMinutes: 150,
    importance: 100,
    regionId: "kyoto"
  },
  {
    ...
    bestTimeByLanguage: { en: ["Opening", "Late afternoon"], ru: ["Opening", "Late afternoon"], ja: ["Opening", "Late afternoon"] },
    difficulty: "moderate",
    durationMinutes: 120,
    importance: 98,
    regionId: "kyoto"
  },
  {
    ...
    bestTimeByLanguage: { en: ["Early morning"], ru: ["Early morning"], ja: ["Early morning"] },
    difficulty: "easy",
    durationMinutes: 90,
    importance: 95,
    regionId: "kyoto"
  },
  {
    ...
    mustVisit: true,
    bestTime: ["Dusk", "Night"],
    bestTimeByLanguage: { en: ["Dusk", "Night"], ru: ["Dusk", "Night"], ja: ["Dusk", "Night"] },
    difficulty: "easy",
    durationMinutes: 120,
    importance: 94,
    regionId: "kyoto"
  },
  {
    ...
    mustVisit: false,
    bestTime: ["Morning"],
    bestTimeByLanguage: { en: ["Morning"], ru: ["Morning"], ja: ["Morning"] },
    difficulty: "easy",
    durationMinutes: 75,
    importance: 86,
    regionId: "kyoto"
  },
  {
    ...
    bestTimeByLanguage: { en: ["Opening", "Cloudy midday"], ru: ["Opening", "Cloudy midday"], ja: ["Opening", "Cloudy midday"] },
    difficulty: "easy",
    durationMinutes: 60,
    importance: 92,
    regionId: "kyoto"
  ...
  },
  {
    ...
    bestTimeByLanguage: { en: ["Morning", "After rain"], ru: ["Morning", "After rain"], ja: ["Morning", "After rain"] },
    difficulty: "active",
    durationMinutes: 210,
    importance: 78,
    regionId: "kyoto"
  },
  {
    ...
    bestTimeByLanguage: { en: ["Late morning"], ru: ["Late morning"], ja: ["Late morning"] },
    difficulty: "easy",
    durationMinutes: 60,
    importance: 74,
    regionId: "kyoto"
  ...
  },
  {
    ...
    bestTimeByLanguage: { en: ["Morning", "Cloudy midday"], ru: ["Morning", "Cloudy midday"], ja: ["Morning", "Cloudy midday"] },
    difficulty: "easy",
    durationMinutes: 120,
    importance: 96
  },
  ...
  },
  {
    ...
    mustVisit: false,
    bestTime: ["Dusk"],
    bestTimeByLanguage: { en: ["Dusk"], ru: ["Dusk"], ja: ["Dusk"] },
    difficulty: "easy",
    durationMinutes: 75,
    importance: 78
  },
  ...
  },
  {
    ...
    bestTimeByLanguage: { en: ["Morning", "Late afternoon"], ru: ["Morning", "Late afternoon"], ja: ["Morning", "Late afternoon"] },
    difficulty: "easy",
    durationMinutes: 30,
    importance: 70
  }
