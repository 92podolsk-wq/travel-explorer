...
export function TripView({ itinerary }: TripViewProps) {
  ...
  return (
    <main className="min-h-dvh bg-muted">
      <header className="flex h-16 items-center gap-2.5 border-b border-border bg-white px-5">
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        ...
        {mapsUrl && (
          <a
            ...
            className="mt-4 inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-white/[0.72] px-3 text-sm font-medium text-foreground shadow-sm transition hover:bg-white"
          >
