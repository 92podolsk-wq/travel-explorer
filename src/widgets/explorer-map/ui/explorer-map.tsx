    ...
    <div className="absolute inset-0">
      ...
      >
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full bg-card text-foreground shadow-panel transition hover:bg-muted/60 disabled:opacity-60"
        >
        ...
        {isNative && presetMapStyleUrl(initialMapStyleId) && (
          <button
            ...
            className={cn(
              ...
              offlineDownloadState === "done" ? "bg-primary/10 text-primary" : "bg-card text-foreground hover:bg-muted/60"
            )}
          >
        ...
        <button
          ...
          className={cn(
            ...
            isAddingMarker ? "bg-primary/10 text-primary" : "bg-card text-foreground hover:bg-muted/60"
          )}
        >
        ...
        <button
          ...
          aria-label="Zoom in"
          title="Zoom in"
          className="flex h-9 w-9 items-center justify-center rounded-full bg-card text-foreground shadow-panel transition hover:bg-muted/60"
        >
      ...
      {isAddingMarker && !pendingMarkerCoords && (
        <div className="absolute left-1/2 top-6 z-30 -translate-x-1/2 rounded-full border border-border bg-card/[0.92] px-4 py-2 text-sm font-semibold text-foreground shadow-soft backdrop-blur-xl">
